defmodule AdventOfCode2024.Day08Test do
  ...
  describe "antinodes A" do
    test "2 antennas, in bound antinodes" do
      ...
      assert Day08.antinodes(antennas, dimensions, &Day08.pair_to_antinodes_a/1) == MapSet.new([{3, 1}, {6, 7}])
    end
    ...
    test "3 antennas, some antinodes out of bounds" do
      ...
      assert Day08.antinodes(antennas, dimensions, &Day08.pair_to_antinodes_a/1) ==
  ...
  describe "antinodes B" do
    test "3 antennas " do
      ...
      assert Day08.antinodes(antennas, dimensions, &Day08.pair_to_antinodes_b/1) ==
